                ...
                <div class="col-md-6">
                    <div class="card  card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Creacion de un rol</h3>
                                ...
                                <div class="col-md-12">
                                    <form action="<?php echo $URL ?>/app/controllers/roles/create.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="tet" name="rol" id="" class="form-control" placeholder="Ingrese nombre de rol" aria-describedby="helpId" required />
