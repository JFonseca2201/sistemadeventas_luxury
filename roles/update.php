                ...
                <div class="col-md-6">
                    <div class="card  card-success">
                        <div class="card-header">
                            <h3 class="card-title">Edicion de un rol</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo $URL ?>/app/controllers/roles/update.php" method="post">
                                        <input type="text" name="id_rol" value="<?php echo $id_roles_get ?>" hidden>
                                        <div class="form-group">
                                            <label for="" class="form-label">Nombre de rol:</label>
                                            <input type="tet" name="rol" id="" class="form-control" value="<?php echo $rol ?>" aria-describedby="helpId" required />
