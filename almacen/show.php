...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">MOSTRAR PRODUCTO</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="<?php echo $URL ?>/app/controllers/almacen/create.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            <label for="" class="form-label">Precio con IVA: </label>
                                                            <input type="text" name="precio_venta" id="" class="form-control" placeholder="" aria-describedby="helpId" value="<?php echo "$ " . number_format($productos_dato['precio_venta'] * 1.15, 2, '.', ',') ?>" disabled />
                                                        </div>
                                                    </div>
                                        ...
                                        <hr>
                                        <div class="form-group">
                                            <a href="index.php" class="btn btn-secondary">Todos lo productos</a>
